...
To draw ER diagrams, you **must** use a drawing software tool. A hand-drawn won't be accepted. Software such as Draw.io, Microsoft Visio, etc. provides tools for drawing ERDs and the option to export diagrams as PDF files. See ERD Drawing Tools for more.
